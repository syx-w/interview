...
(function (window) {
  const PENDING = 'pending'
  const REFUILD = 'fulfilled'
  const REJECTED = 'rejected'
  var status
  var callBacks = [] // 回调函数数组 数据结构：[{onRejected(){},onResolved(){}}]
  var data
  ...
  Promise.prototype.then = function (onResolved, onRejected) {
    onResolved = typeof onResolved === 'function' ? onResolved : value => value
    onRejected = typeof onResolved === 'function' ? onRejected : value => {
      throw value
    }
    let that = this
